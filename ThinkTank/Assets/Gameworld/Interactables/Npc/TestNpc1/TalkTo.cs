...
public class TalkTo : MonoBehaviour
{
    ...
    //hasbools and components/gameobject connections
    public Boolhavior Boolhavior;
    ...
    public void Initiate()
    {
        switch (TalkState)
        {
            case 0:
                {
                    Boolhavior.TalkBox.SetActive(true);
                    Boolhavior.TManager.StartConvo(TBlock0);
                    TalkState = 1;
                    Another = true;
            ...
            case 1:
                {
                    Boolhavior.ChoiceUI.SetActive(true);
